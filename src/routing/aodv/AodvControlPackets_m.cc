//
// Generated file, do not edit! Created by nedtool 5.7 from routing/aodv/AodvControlPackets.msg.
//
...
EXECUTE_ON_STARTUP(
    ...
    e->insert(RREQSEC, "RREQSEC");
    e->insert(RREPSEC, "RREPSEC");
...
bool RrepDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_hopCount: pp->setHopCount(string2ulong(value)); return true;
        case FIELD_destSeqNum: pp->setDestSeqNum(string2ulong(value)); return true;
        case FIELD_lifeTime: pp->setLifeTime(string2simtime(value)); return true;
        default: return false;
    }
}
...
Register_Class(RreqSec)

RreqSec::RreqSec() : ::inet::aodv::AodvControlPacket()
{
}

RreqSec::RreqSec(const RreqSec& other) : ::inet::aodv::AodvControlPacket(other)
{
    copy(other);
}
...
RreqSec& RreqSec::operator=(const RreqSec& other)
{
    if (this == &other) return *this;
    ::inet::aodv::AodvControlPacket::operator=(other);
    copy(other);
...
void RreqSec::copy(const RreqSec& other)
{
    this->joinFlag = other.joinFlag;
    this->repairFlag = other.repairFlag;
    this->gratuitousRREPFlag = other.gratuitousRREPFlag;
...
void RreqSec::parsimPack(omnetpp::cCommBuffer *b) const
{
    ::inet::aodv::AodvControlPacket::parsimPack(b);
    doParsimPacking(b,this->joinFlag);
    doParsimPacking(b,this->repairFlag);
...
void RreqSec::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ::inet::aodv::AodvControlPacket::parsimUnpack(b);
    doParsimUnpacking(b,this->joinFlag);
    doParsimUnpacking(b,this->repairFlag);
...
bool RreqSec::getJoinFlag() const
{
    return this->joinFlag;
}

void RreqSec::setJoinFlag(bool joinFlag)
{
    handleChange();
    this->joinFlag = joinFlag;
}

bool RreqSec::getRepairFlag() const
{
    return this->repairFlag;
}

void RreqSec::setRepairFlag(bool repairFlag)
{
    handleChange();
    this->repairFlag = repairFlag;
}

bool RreqSec::getGratuitousRREPFlag() const
{
    return this->gratuitousRREPFlag;
}

void RreqSec::setGratuitousRREPFlag(bool gratuitousRREPFlag)
{
    handleChange();
    this->gratuitousRREPFlag = gratuitousRREPFlag;
}

bool RreqSec::getDestOnlyFlag() const
{
    return this->destOnlyFlag;
}

void RreqSec::setDestOnlyFlag(bool destOnlyFlag)
{
    handleChange();
    this->destOnlyFlag = destOnlyFlag;
}

bool RreqSec::getUnknownSeqNumFlag() const
{
    return this->unknownSeqNumFlag;
}

void RreqSec::setUnknownSeqNumFlag(bool unknownSeqNumFlag)
{
    handleChange();
    this->unknownSeqNumFlag = unknownSeqNumFlag;
}

uint16_t RreqSec::getReserved() const
{
    return this->reserved;
}

void RreqSec::setReserved(uint16_t reserved)
{
    handleChange();
    this->reserved = reserved;
}

unsigned int RreqSec::getHopCount() const
{
    return this->hopCount;
}

void RreqSec::setHopCount(unsigned int hopCount)
{
    handleChange();
    this->hopCount = hopCount;
}

uint32_t RreqSec::getRreqId() const
{
    return this->rreqId;
}

void RreqSec::setRreqId(uint32_t rreqId)
{
    handleChange();
    this->rreqId = rreqId;
}

const L3Address& RreqSec::getDestAddr() const
{
    return this->destAddr;
}

void RreqSec::setDestAddr(const L3Address& destAddr)
{
    handleChange();
    this->destAddr = destAddr;
}

uint32_t RreqSec::getDestSeqNum() const
{
    return this->destSeqNum;
}

void RreqSec::setDestSeqNum(uint32_t destSeqNum)
{
    handleChange();
    this->destSeqNum = destSeqNum;
}

const L3Address& RreqSec::getOriginatorAddr() const
{
    return this->originatorAddr;
}

void RreqSec::setOriginatorAddr(const L3Address& originatorAddr)
{
    handleChange();
    this->originatorAddr = originatorAddr;
}

uint32_t RreqSec::getOriginatorSeqNum() const
{
    return this->originatorSeqNum;
}

void RreqSec::setOriginatorSeqNum(uint32_t originatorSeqNum)
{
    handleChange();
    this->originatorSeqNum = originatorSeqNum;
}

const char * RreqSec::getHash() const
{
    return this->hash.c_str();
}

void RreqSec::setHash(const char * hash)
{
    handleChange();
    this->hash = hash;
}

int RreqSec::getLength() const
{
    return this->length;
}

void RreqSec::setLength(int length)
{
    handleChange();
    this->length = length;
}

const char * RreqSec::getSignature() const
{
    return this->signature.c_str();
}

void RreqSec::setSignature(const char * signature)
{
    handleChange();
    this->signature = signature;
}

class RreqSecDescriptor : public omnetpp::cClassDescriptor
{
  private:
    mutable const char **propertynames;
    enum FieldConstants {
...
Register_ClassDescriptor(RreqSecDescriptor)

RreqSecDescriptor::RreqSecDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::aodv::RreqSec)), "inet::aodv::AodvControlPacket")
{
    propertynames = nullptr;
}

RreqSecDescriptor::~RreqSecDescriptor()
{
    delete[] propertynames;
}

bool RreqSecDescriptor::doesSupport(omnetpp::cObject *obj) const
{
    return dynamic_cast<RreqSec *>(obj)!=nullptr;
}

const char **RreqSecDescriptor::getPropertyNames() const
{
    if (!propertynames) {
        static const char *names[] = {  nullptr };
        omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
...
const char *RreqSecDescriptor::getProperty(const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? basedesc->getProperty(propertyname) : nullptr;
}

int RreqSecDescriptor::getFieldCount() const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? 15+basedesc->getFieldCount() : 15;
}

unsigned int RreqSecDescriptor::getFieldTypeFlags(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *RreqSecDescriptor::getFieldName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int RreqSecDescriptor::findField(const char *fieldName) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    int base = basedesc ? basedesc->getFieldCount() : 0;
    if (fieldName[0] == 'j' && strcmp(fieldName, "joinFlag") == 0) return base+0;
    ...
    if (fieldName[0] == 'o' && strcmp(fieldName, "originatorAddr") == 0) return base+10;
    if (fieldName[0] == 'o' && strcmp(fieldName, "originatorSeqNum") == 0) return base+11;
    if (fieldName[0] == 'h' && strcmp(fieldName, "hash") == 0) return base+12;
    if (fieldName[0] == 'l' && strcmp(fieldName, "length") == 0) return base+13;
    if (fieldName[0] == 's' && strcmp(fieldName, "signature") == 0) return base+14;
    return basedesc ? basedesc->findField(fieldName) : -1;
}

const char *RreqSecDescriptor::getFieldTypeString(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char **RreqSecDescriptor::getFieldPropertyNames(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *RreqSecDescriptor::getFieldProperty(int field, const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int RreqSecDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    RreqSec *pp = (RreqSec *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

const char *RreqSecDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string RreqSecDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool RreqSecDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    switch (field) {
        ...
        case FIELD_destSeqNum: pp->setDestSeqNum(string2ulong(value)); return true;
        case FIELD_originatorSeqNum: pp->setOriginatorSeqNum(string2ulong(value)); return true;
        case FIELD_hash: pp->setHash((value)); return true;
...
const char *RreqSecDescriptor::getFieldStructName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *RreqSecDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
Register_Class(RrepSec)

RrepSec::RrepSec() : ::inet::aodv::AodvControlPacket()
{
}

RrepSec::RrepSec(const RrepSec& other) : ::inet::aodv::AodvControlPacket(other)
{
    copy(other);
}
...
RrepSec& RrepSec::operator=(const RrepSec& other)
{
    if (this == &other) return *this;
    ::inet::aodv::AodvControlPacket::operator=(other);
    copy(other);
...
void RrepSec::copy(const RrepSec& other)
{
    this->repairFlag = other.repairFlag;
    this->ackRequiredFlag = other.ackRequiredFlag;
    this->reserved = other.reserved;
...
void RrepSec::parsimPack(omnetpp::cCommBuffer *b) const
{
    ::inet::aodv::AodvControlPacket::parsimPack(b);
    doParsimPacking(b,this->repairFlag);
    doParsimPacking(b,this->ackRequiredFlag);
...
void RrepSec::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ::inet::aodv::AodvControlPacket::parsimUnpack(b);
    doParsimUnpacking(b,this->repairFlag);
    doParsimUnpacking(b,this->ackRequiredFlag);
...
bool RrepSec::getRepairFlag() const
{
    return this->repairFlag;
}

void RrepSec::setRepairFlag(bool repairFlag)
{
    handleChange();
    this->repairFlag = repairFlag;
}

bool RrepSec::getAckRequiredFlag() const
{
    return this->ackRequiredFlag;
}

void RrepSec::setAckRequiredFlag(bool ackRequiredFlag)
{
    handleChange();
    this->ackRequiredFlag = ackRequiredFlag;
}

uint16_t RrepSec::getReserved() const
{
    return this->reserved;
}

void RrepSec::setReserved(uint16_t reserved)
{
    handleChange();
    this->reserved = reserved;
}

unsigned int RrepSec::getPrefixSize() const
{
    return this->prefixSize;
}

void RrepSec::setPrefixSize(unsigned int prefixSize)
{
    handleChange();
    this->prefixSize = prefixSize;
}

unsigned int RrepSec::getHopCount() const
{
    return this->hopCount;
}

void RrepSec::setHopCount(unsigned int hopCount)
{
    handleChange();
    this->hopCount = hopCount;
}

const L3Address& RrepSec::getDestAddr() const
{
    return this->destAddr;
}

void RrepSec::setDestAddr(const L3Address& destAddr)
{
    handleChange();
    this->destAddr = destAddr;
}

uint32_t RrepSec::getDestSeqNum() const
{
    return this->destSeqNum;
}

void RrepSec::setDestSeqNum(uint32_t destSeqNum)
{
    handleChange();
    this->destSeqNum = destSeqNum;
}

const L3Address& RrepSec::getOriginatorAddr() const
{
    return this->originatorAddr;
}

void RrepSec::setOriginatorAddr(const L3Address& originatorAddr)
{
    handleChange();
    this->originatorAddr = originatorAddr;
}

omnetpp::simtime_t RrepSec::getLifeTime() const
{
    return this->lifeTime;
}

void RrepSec::setLifeTime(omnetpp::simtime_t lifeTime)
{
    handleChange();
    this->lifeTime = lifeTime;
}

const char * RrepSec::getHash() const
{
    return this->hash.c_str();
}

void RrepSec::setHash(const char * hash)
{
    handleChange();
    this->hash = hash;
}

int RrepSec::getLength() const
{
    return this->length;
}

void RrepSec::setLength(int length)
{
    handleChange();
    this->length = length;
}

const char * RrepSec::getSignature() const
{
    return this->signature.c_str();
}

void RrepSec::setSignature(const char * signature)
{
    handleChange();
    this->signature = signature;
}

class RrepSecDescriptor : public omnetpp::cClassDescriptor
{
  private:
    mutable const char **propertynames;
    enum FieldConstants {
...
Register_ClassDescriptor(RrepSecDescriptor)

RrepSecDescriptor::RrepSecDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::aodv::RrepSec)), "inet::aodv::AodvControlPacket")
{
    propertynames = nullptr;
}

RrepSecDescriptor::~RrepSecDescriptor()
{
    delete[] propertynames;
}

bool RrepSecDescriptor::doesSupport(omnetpp::cObject *obj) const
{
    return dynamic_cast<RrepSec *>(obj)!=nullptr;
}

const char **RrepSecDescriptor::getPropertyNames() const
{
    if (!propertynames) {
        static const char *names[] = {  nullptr };
        omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
...
const char *RrepSecDescriptor::getProperty(const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? basedesc->getProperty(propertyname) : nullptr;
}

int RrepSecDescriptor::getFieldCount() const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? 12+basedesc->getFieldCount() : 12;
}

unsigned int RrepSecDescriptor::getFieldTypeFlags(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *RrepSecDescriptor::getFieldName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int RrepSecDescriptor::findField(const char *fieldName) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    int base = basedesc ? basedesc->getFieldCount() : 0;
    if (fieldName[0] == 'r' && strcmp(fieldName, "repairFlag") == 0) return base+0;
    ...
    if (fieldName[0] == 'o' && strcmp(fieldName, "originatorAddr") == 0) return base+7;
    if (fieldName[0] == 'l' && strcmp(fieldName, "lifeTime") == 0) return base+8;
    if (fieldName[0] == 'h' && strcmp(fieldName, "hash") == 0) return base+9;
    if (fieldName[0] == 'l' && strcmp(fieldName, "length") == 0) return base+10;
    if (fieldName[0] == 's' && strcmp(fieldName, "signature") == 0) return base+11;
    return basedesc ? basedesc->findField(fieldName) : -1;
}

const char *RrepSecDescriptor::getFieldTypeString(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char **RrepSecDescriptor::getFieldPropertyNames(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *RrepSecDescriptor::getFieldProperty(int field, const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int RrepSecDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    RrepSec *pp = (RrepSec *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

const char *RrepSecDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string RrepSecDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool RrepSecDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *RrepSecDescriptor::getFieldStructName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *RrepSecDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
